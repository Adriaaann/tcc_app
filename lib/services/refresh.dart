...
class FinancialDataService {
  ...
  final StreamController<List<List<FinancialFormData>>> _controller =
      StreamController.broadcast();

  Stream<List<List<FinancialFormData>>> get stream => _controller.stream;
  ...
  Future<void> _loadData() async {
    ...
    _controller.add([expenses, subscriptions]);
  }
